...
namespace PeliculasAPI.Migrations
{
    ...
    [Migration("20220509054805_SalaDeCineData")]
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.Pelicula", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 6,
                            EnCines = false,
                            FechaEstreno = new DateTime(2022, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            EnCines = false,
                            FechaEstreno = new DateTime(2022, 6, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Titulo = "Emma"
                        },
                        new
                        {
                            Id = 8,
                            EnCines = false,
                            FechaEstreno = new DateTime(2022, 11, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("PeliculasAPI.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 4,
                            Nombre = "Sambil",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-69.9118804 18.482614)")
                        },
                        new
                        {
                            Id = 5,
                        ...
                        new
                        {
                            ...
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-73.986227 50.730898)")
                        });
                });
